...
void test2()
{
	...
	LogWarn("this is a error message! number = %d, str = %s", number, pstr);
	LogInfo("this is a error message! number = %d, str = %s", number, pstr);
	LogDebug("this is a error message! number = %d, str = %s", number, pstr);
}
